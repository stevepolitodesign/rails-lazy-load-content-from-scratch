...
- [Lazy-loading content with Turbo Frames and skeleton loader](https://boringrails.com/tips/turboframe-lazy-load-skeleton)
...
![Web response](./public/web_response.png)
